...
if(localStorage.getItem('parCatId')!=null){

    console.log("i here "); 
    let id =localStorage.getItem('parCatId');
    console.log(localStorage.getItem('parCatId'));
    ...
    //   // slider.innerHTML=imgTags;
       let subs= await CategoryService.getCategoryWithSubcategoriesByParentId(id);
console.log(subs)
       let pro="";
       for(let i=0;i<subs.subcategories.length;i++){
        ...
        <div class="card-btn">
            <a href="wall/index.html" data-page-id="6Y6vjkmEquCD12jWnPWDJ6" data-page-type="product" class="category-page-link">
                <div class="image-container">
                    ...
                    <picture class="">
                    <img src="${en.hostImage+subs.subcategories[i].category_img}" alt="" class=" ls-is-cached lazyloaded" width="600" height="600">
                    </picture>
                </div>
            </a>
            <div class="card-body">
                <a href="wall/index.html" class="card-title category-page-link" data-page-id="6Y6vjkmEquCD12jWnPWDJ6" data-page-type="product">
                    ${subs.subcategories[i].category_name}
                </a>
            </div>
        </div>
